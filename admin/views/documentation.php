...
<div class="wrap cc-docs">
    ...
    <div class="cc-card" id="cc-new">
        ...
        <ul style="list-style:disc;margin-left:20px;">
            ...
            <li><strong>BOX NOW Parcel ID</strong> <span class="cc-new">ΝΕΟ</span>: για αποστολές BOX NOW εμφανίζεται πλέον ο αριθμός δέματος της BOX NOW — στο meta box της παραγγελίας και στη στήλη «Tracking» της λίστας παραγγελιών.</li>
    ...
    <div class="cc-card" id="cc-settings">
        ...
        <p><strong>BOX NOW Parcel ID</strong> <span class="cc-new">ΝΕΟ</span>: μόλις δημιουργηθεί voucher BOX NOW, το Courier Center επιστρέφει και τον αριθμό δέματος της BOX NOW. Εμφανίζεται στο meta box της παραγγελίας και στη στήλη «Tracking» της λίστας παραγγελιών. Υπάρχει μόνο σε αποστολές BOX NOW και μόνο όσο η αποστολή είναι ενεργή.</p>
