...
<div class="wrap cc-docs">
    ...
    <div class="cc-card" id="cc-intro">
        ...
        <table class="cc-tbl">
            ...
            <tr><td>Έλεγχος μεθόδων αποστολής <span class="cc-new">ΝΕΟ</span></td><td>Το plugin διαχειρίζεται μόνο τις μεθόδους αποστολής που επιλέγετε</td></tr>
        </table>
    </div>
    ...
    <div class="cc-card" id="cc-settings">
        ...
        <p><strong>Προεπιλεγμένη επιλογή BOX NOW</strong> <span class="cc-new">ΝΕΟ</span>: αν την ενεργοποιήσετε, το BOX NOW εμφανίζεται ήδη τσεκαρισμένο και κλειδωμένο μόλις ο πελάτης διαλέξει μέθοδο Courier Center. Για να το αφαιρέσει, ο πελάτης επιλέγει άλλη μέθοδο αποστολής.</p>

        <h3>🚚 Μέθοδοι αποστολής που διαχειρίζεται το plugin <span class="cc-new">ΝΕΟ</span></h3>
    ...
    <div class="cc-card" id="cc-create">
        ...
        <div class="cc-warn">
            <strong>Έλεγχος μεθόδου αποστολής</strong> <span class="cc-new">ΝΕΟ</span>: αν η παραγγελία χρησιμοποιεί μέθοδο που <em>δεν</em> διαχειρίζεται το plugin, πριν τη δημιουργία εμφανίζεται επιβεβαίωση («Είστε σίγουροι ότι θέλετε να δημιουργήσετε την αποστολή στην Courier Center;»). Η αυτόματη &amp; μαζική δημιουργία τις παραλείπει εντελώς.
        </div>
    ...
    <div class="cc-card" id="cc-track">
        ...
        <p>Εμφανίζονται αυτόματα οι στήλες «CC Voucher», «CC Status», «Τύπος» και <strong>«Μέθοδος Αποστολής»</strong> <span class="cc-new">ΝΕΟ</span> (πράσινο badge = διαχειρίζεται από το plugin, γκρι = όχι).</p>
        <table class="cc-tbl">
    ...
    <div class="cc-card" id="cc-bulk">
        ...
        <div class="cc-tip">Παραγγελίες με υπάρχον voucher παραλείπονται. <strong>Παραγγελίες με μη διαχειρίσιμη μέθοδο αποστολής παραλείπονται επίσης</strong> <span class="cc-new">ΝΕΟ</span>. Μετά τη μαζική δημιουργία, ελέγξτε το notice για τα αποτελέσματα.</div>
    </div>
